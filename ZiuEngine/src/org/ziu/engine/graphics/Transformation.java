...
public class Transformation {
    ...
    public Matrix4f updateProjectionMatrix(float fov, float width, float height, float zNear, float zFar) {
        ...
        return projectionMatrix.setPerspective(fov, width / (float)height, zNear, zFar);
    }
    ...
    public Matrix4f buildModelViewMatrix(GameObject gameItem, Matrix4f matrix) {
    ...
    public Matrix4f buildModelLightViewMatrix(GameObject gameItem, Matrix4f matrix) {
        Vector3f rotation = gameItem.getRotation();
