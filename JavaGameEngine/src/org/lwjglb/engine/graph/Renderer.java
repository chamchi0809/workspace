...
public class Renderer {
    ...
    private void setupSceneShader() throws Exception {
        ...
        sceneShaderProgram.createVertexShader(Utils.loadResource("resources/vertex.vs"));
        sceneShaderProgram.createFragmentShader(Utils.loadResource("resources/fragment.fs"));
